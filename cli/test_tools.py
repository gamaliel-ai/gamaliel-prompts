...
from cli.tools import (
    get_scripture, search_scripture_semantic, list_bible_books,
    get_scripture_context, execute_tool, SCRIPTURE_TOOLS
)
...
class TestScriptureTools:
    ...
    def test_get_scripture_chapter_success(self, mock_get_parser):
        ...
        result = get_scripture("Genesis", 1, bible_id="bsb")
    ...
    def test_get_scripture_unsupported_bible(self):
        """Test error handling for unsupported Bible translation."""
        result = get_scripture("John", 3, 16, "kjv")
        
        assert "error" in result
        assert "not supported" in result["error"]
        assert "BSB is available" in result["error"]
    ...
    def test_get_scripture_verse_not_found(self, mock_get_parser):
        ...
        result = get_scripture("John", 3, 999, "bsb")
    ...
    def test_get_scripture_chapter_not_found(self, mock_get_parser):
        ...
        result = get_scripture("John", 999, bible_id="bsb")
    ...
    def test_search_scripture_unsupported_bible(self):
        ...
        result = search_scripture_semantic("love", "kjv")
...
class TestToolSchema:
    ...
    def test_get_scripture_tool_schema(self):
        ...
        get_scripture_tool = next(t for t in SCRIPTURE_TOOLS if t["function"]["name"] == "get_scripture")
        ...
        assert "bible_id" in get_scripture_tool["function"]["parameters"]["properties"]
    ...
    def test_search_scripture_tool_schema(self):
        ...
        search_tool = next(t for t in SCRIPTURE_TOOLS if t["function"]["name"] == "search_scripture_semantic")
